...
- Цвета не должны покрываться автоматическими тестами: не фиксируйте в тестах палитру, hex/rgb/hsl-значения, CSS-переменные цвета и цветовые Tailwind-классы.
